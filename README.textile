...
See "groovyx-osgi":http://github.com/jetztgradnet/groovyx-osgi/groovyx-osgi/README.textile for details.
...
See "groovyx-osgi-runtime":http://github.com/jetztgradnet/groovyx-osgi/groovyx-osgi-runtime/README.textile for details.
...
Simply run @gradle build@. If "Gradle":http://www.gradle.org >= 0.9-rc-1 is not installed, run @./gradlew build@ from the top-level directory, in order to automatically download the correct Gradle version. The resulting jars can be found at the following locations:
